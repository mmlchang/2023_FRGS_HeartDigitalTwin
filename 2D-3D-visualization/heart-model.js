...
// export function loadHeartModel(div) {
...
//   // TOOLTIP
//   // 
//   // GLOBAL ORIGIN MARKING
//   const geometry = new THREE.SphereGeometry(0.1, 16, 16); // radius 0.1, 16 segments
//   const pivotMarker = new THREE.Mesh(geometry, material);
//   pivotMarker.position.set(0, 0, 0); // Place at world origin
//   scene.add(pivotMarker); // Add to scene
...
//     if (pivot) {
//       pivot.rotation.y += 0.001; // yaw
//       // pivot.rotation.x += 0.001; // pitch
//       // pivot.rotation.z += 0.001; // roll
//     }
//     controls.update();
...
// /**
//  * @param {HTMLElement} div - container div
//  * @param {Array} strainData - array of objects with Class, File, Color
//  */
// export function loadHeartModel(div, strainData) {
//   const w = div.clientWidth;
//   const h = div.clientHeight;
...
//   const pivotMarkerMat = new THREE.MeshBasicMaterial({ color: 0xffffff });
//   const pivotMarker = new THREE.Mesh(new THREE.SphereGeometry(0.1, 16, 16), pivotMarkerMat);
//   pivotMarker.position.set(0, 0, 0);
//   scene.add(pivotMarker);
...
//   // GROUP TO HOLD HEART SEGMENTS
//   const group = new THREE.Group();
//   group.position.set(0, 0, 0);
//   scene.add(group);

//   // LOAD OBJECTS USING COLORS FROM strainData
//   const loader = new OBJLoader();
//   let loadCount = 0;
